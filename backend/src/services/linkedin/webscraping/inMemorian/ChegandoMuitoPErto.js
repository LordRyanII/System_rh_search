...
module.exports = class LinkedinWebscraping {
    constructor() {
        ...
        this.isLoggedIn = false; // Novo sinalizador para verificar o status do login
    }
    ...
    async pesquisarContato(url) {
        ...
        await this.page.waitForSelector('.top-card-layout__title');
    ...
    filtrarDados(html) {
        ...
        fs.writeFileSync('./log/sucess/jsonCandidato.json', JSON.stringify(dados));
        return dados;
    }
